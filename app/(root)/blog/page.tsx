...
export async function generateMetadata(props: {
  ...
  let title = "ঘানি গল্প ও স্বাস্থ্যকথা | Grihinir Bari (গৃহিণীর বাড়ি) Journal";
  if (params.category && params.category !== "All") {
    title = `${params.category} | Grihinir Bari (গৃহিণীর বাড়ি)`;
  } else if (params.search) {
    title = `অনুসন্ধান: "${params.search}" | Grihinir Bari Journal`;
  }

  const description =
    "খাঁটি সরষের তেলের স্বাস্থ্য উপকারিতা, সনাতন কাঠের ঘানি প্রযুক্তি, খাঁটি তেল চেনার উপায় ও ঐতিহ্যবাহী বাঙালি রান্নার সেরা রেসিপি পড়ুন গৃহিণীর বাড়ি জার্নালে।";
  ...
  return {
    title,
    description,
    keywords: ["Grihinir Bari Journal", "খাঁটি সরষের তেলের উপকারিতা", "কাঠের ঘানির গল্প", "Mustard Oil Health Benefits BD", "বাঙালি রান্নায় সরষের তেল"],
    alternates: {
      canonical,
    },
    openGraph: {
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Grihinir Bari Journal & Heritage Stories",
        },
      ],
      type: "website",
    },
...
export default async function BlogIndexPage(props: {
  ...
  const collectionPageJsonLd = {
    ...
    "@type": "CollectionPage",
    name: "গৃহিণীর বাড়ি - ঘানি গল্প ও স্বাস্থ্যকথা",
    description: "খাঁটি সরষের তেলের স্বাস্থ্য উপকারিতা, ঐতিহ্যবাহী কাঠের ঘানি প্রযুক্তি ও খাঁটি পণ্যের গল্প।",
    url: `${baseUrl}/blog`,
    mainEntity: {
      "@type": "ItemList",
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#271C16] pb-24">
      <script
          ...
          {categories.map((cat) => {
            ...
            return (
              <Link
                key={cat}
                href={href}
                className={`px-4 py-2 rounded-full text-xs font-bold transition shrink-0 ${isActive
