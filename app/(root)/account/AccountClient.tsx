    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="border-b border-zinc-200 pb-4">
        <h1 className="text-2xl sm:text-3xl font-extrabold font-serif text-[#271C16]">
          অর্ডার ট্র্যাকিং ও একাউন্ট পোর্টাল
        </h1>
        <p className="text-xs text-[#8C7662]">গৃহিণীর বাড়ি থেকে আপনার সরষের তেল অর্ডারের লাইভ স্ট্যাটাস দেখুন</p>
      </div>

      {/* Track Order Search Card */}
      <div className="bg-white text-black p-6 sm:p-8 rounded-3xl border border-[#EADFCF] shadow-sm space-y-4">
        <h2 className="text-xs font-extrabold uppercase tracking-[0.2em] text-[#271C16] flex items-center gap-2">
          <Search className="w-4 h-4 text-[#C88A2B]" /> অর্ডার অনুসন্ধান করুন
        </h2>
        <form onSubmit={handleSearchOrder} className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            placeholder="অর্ডার নম্বর (যেমন: GB-1002) অথবা মোবাইল নম্বর লিখুন..."
